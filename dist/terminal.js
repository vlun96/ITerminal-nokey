...
___CSS_LOADER_EXPORT___.push([module.id, `body {
    background-color: rgb(225, 197, 160);
    display: flex;
...
.idContainer {
    ...
    background-color: rgb(171, 194, 216)
}
...
.idContainer textarea#txtOutput {
    width: 50vw;
    height: 60vh;
    margin-left: 0.2em;
    margin-top: 0.2em;
...
.btnSend {
    background-color: rgb(37, 74, 130);
    color: white;
    margin-left: 0.2em;
    margin-top: 0.2em;
    font-size: 1.2rem;
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
